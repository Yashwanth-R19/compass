...
export const LIMITATIONS: string[] = [
  ...
  "Test-gap (test-maintenance) analysis and the cross-repository portfolio view were both cut from this product entirely — the rebuild that simplified this UI removed them as feature sprawl rather than keeping a half-used surface around.",
